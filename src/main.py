...
def main():
    ...
    downsampled_fire = downsample_fire_data(fire_data, block_size=(500, 500), slice_shape=(4, 4))
    ...
    qubo = create_qubo(full_matrix, lambda1=0.5, lambda2=10000, k_constraint=3)
